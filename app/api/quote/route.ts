...
export async function POST(request: Request) {
  try {
    ...
    const { name, company, email, phone, service, location, details } = body;
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: #0f1b2d; padding: 24px 32px; border-radius: 12px 12px 0 0;">
            <h1 style="color: #d4a017; margin: 0; font-size: 20px;">New Quote Request</h1>
          </div>
          <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6; font-size: 14px;">${company || "N/A"}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6; font-size: 14px; font-weight: 600; color: #8b6914;">${service}</td>
              </tr>
              <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6; color: #6b7280; font-size: 13px;">Location</td>
                <td style="padding: 10px 0; border-bottom: 1px solid #f3f4f6; font-size: 14px;">${location || "Not specified"}</td>
              </tr>
            </table>
            ${details ? `
            <div style="margin-top: 20px;">
              <p style="color: #6b7280; font-size: 13px; margin: 0 0 8px;">Project Details</p>
            ...
            <div style="margin-top: 24px; padding-top: 16px; border-top: 1px solid #f3f4f6; font-size: 11px; color: #9ca3af;">
              Sent from caprasecurity.ca quote form
            </div>
          </div>
        </div>
      `,
